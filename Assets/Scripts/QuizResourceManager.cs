...
public class QuizResourceManager : MonoBehaviour
{
    string[][] listaPreguntas = new string[9][];
    public static QuizResourceManager sharedInstance;
    private void Awake()
    {
    ...
    public void cargarRecursosEnQuizManager()
    {
        ...
        QuizManager.sharedInstance.listaPreguntas = this.listaPreguntas;
        QuizManager.sharedInstance.prepararQuiz();
    }
}
